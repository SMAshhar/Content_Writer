...
from agents_tasks_ms import agents, tasks
...
# budgeting_path = current_file_path / "budgetting.md"
# with open(budgeting_path, "r") as f:
#     budgeting = f.read()
    # print(budgeting)
...
def marketing_strategy (
    ...
    user_input.update({"refined_business_idea":refined_business_idea, "budgeting":budgeting})
