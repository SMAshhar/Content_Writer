...
agents: dict[str, BusinessIdeaAgent] = {
    "business_researcher":{
        ...
        "goal":("Use {refined_business_idea} to research on marketing benchmark, tools, "
                "equipment, resources, licenses etc and list down all business needs "
...
tasks:dict[str, BusinessIdeaTask] = {
    "business_requirements": {
        "description":(
            ...
            "list down the requirements for the business idea to succeed in a .md format "
        ),
        "expected_output":(
    ...
    "budget_assignment":{
        "description":(
            ...
            "assign budget to each item. search the internet for more accurate prices on the {location} "
        ...
        "agent":Agent,
        "async_execution":False,
        "output_file":"refined_business_idea.csv"
    }
}